...
class AppColors {
  ...
  static const Color mainColor = Color(0xFFDBCDA8);
  ...
  static const Color paraCalor = Color(0xFF8f837f);
  static const Color buttonBackgroundColor = Color(0xFFf7f6f4);
  static Color signColor = const Color(0xFFa9a29f);
  static const Color titleGoloc = Color(0xFF5c524f);
  static const Color mainBlacklalor = Color(0xFF332d2b);
